var disasterTexts = {
    ...
    tsunami: {
        ...
        typhoon: [
        { //1
            message: "Which is safer place to evacuate?",
            //message: "Which indicates 'earthquake'?",
            left: true,
            dummy: [10, 90],
        },
        { //2
            message: "Which is more dangerous?",
            left: false,
            dummy: [80, 20],
        },
    ],
     snow: [
         { //1
            message: "In this situation, would you like to call the fire department? Or do you run away by yourself?",
            //message: "Which indicates 'earthquake'?",
            left: true,
            dummy: [90, 10],
        },
        { //2
            message: "Which is more slippery?",
            left: false,
            dummy: [20, 80],
        },
    ],
